...
router.post("/tasksPdfReport", task_middlewares_1.exportTasksMiddlewares, task_controller_1.tasksPdfReport);
router.post("/tasksXlsxReport", task_middlewares_1.exportTasksMiddlewares, task_controller_1.tasksXlsxReport);
