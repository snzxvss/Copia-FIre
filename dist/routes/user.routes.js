...
router.post("/usersPdfReport", user_middlewares_1.exportUsersMiddlewares, user_controller_1.usersPdfReport);
router.post("/usersXlsxReport", user_middlewares_1.exportUsersMiddlewares, user_controller_1.usersXlsxReport);
