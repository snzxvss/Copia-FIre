...
router.post("/clientsPdfReport", client_middlewares_1.exportClientsMiddlewares, client_controller_1.clientsPdfReport);
router.post("/clientsXlsxReport", client_middlewares_1.exportClientsMiddlewares, client_controller_1.clientsXlsxReport);
